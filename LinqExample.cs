...
new Employee() {EmployeeID = 1001,FirstName = "Imam",LastName = "Shaik",Title = "Senior Analyst",DOB = DateTime.Parse("10/06/1992"),DOJ = DateTime.Parse("09/08/2011"),City = "Banglore"},
new Employee() {EmployeeID = 1002,FirstName = "Asia",LastName = "Shaik",Title = "AsstManager",DOB = DateTime.Parse("20/08/1993"),DOJ = DateTime.Parse("07/07/2012"),City = "Banglore"},
new Employee() {EmployeeID = 1003,FirstName = "Sujeet",LastName = "kumar",Title = "SE",DOB = DateTime.Parse("14/11/1992"),DOJ = DateTime.Parse("12/4/2015"),City = "Bihar"},
